...
PLATINUMCOIND=${1}/platinumcoind
CLI=${1}/platinumcoin-cli
...
B4ARGS="-datadir=$D4"
$PLATINUMCOIND $PLATINUMCOINDARGS $B4ARGS &
B4PID=$!
...
function StartThree {
  $PLATINUMCOIND $PLATINUMCOINDARGS $B1ARGS &
  B1PID=$!
  $PLATINUMCOIND $PLATINUMCOINDARGS $B2ARGS &
  B2PID=$!
  $PLATINUMCOIND $PLATINUMCOINDARGS $B3ARGS &
  B3PID=$!
}
