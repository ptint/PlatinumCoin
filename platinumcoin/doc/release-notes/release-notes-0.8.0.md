Platinumcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/platinumcoin/files/Platinumcoin/platinumcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Platinumcoin
...
New/changed settings (command-line or platinumcoin.conf file)
--------------------------------------------------------
