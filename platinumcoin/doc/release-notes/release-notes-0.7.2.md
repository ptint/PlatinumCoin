Platinumcoin version 0.7.2 is now available from:
  http://sourceforge.net/projects/platinumcoin/files/Platinumcoin/platinumcoin-0.7.2
...
* Fix use-after-free problems in initialization and shutdown, the latter of
  which caused Platinumcoin-Qt to crash on Windows when exiting.
