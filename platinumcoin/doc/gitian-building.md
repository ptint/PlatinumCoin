...
*Setup instructions for a gitian build of Platinumcoin using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Platinumcoin
...
- [Building Platinumcoin](#building-platinumcoin)
...
Clone the git repositories for platinumcoin and gitian,

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/platinumcoin/platinumcoin
```
...
In [doc/release-process.md](release-process.md) in the platinumcoin repository under 'Fetch and build inputs'.
...
Building Platinumcoin
----------------

To build Platinumcoin (for Linux and/or Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the platinumcoin repository.

Output from `gbuild` will look something like

    Initialized empty Git repository in /home/debian/gitian-builder/inputs/platinumcoin/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/platinumcoin/platinumcoin
...
For example:
```bash
URL=https://github.com/laanwj/platinumcoin.git
COMMIT=2014_03_windows_unicode_path
./bin/gbuild --commit platinumcoin=${COMMIT} --url platinumcoin=${URL} ../platinumcoin/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit platinumcoin=${COMMIT} --url platinumcoin=${URL} ../platinumcoin/contrib/gitian-descriptors/gitian-win.yml
```
...
```bash
    gpg --detach-sign ${VERSION}/${SIGNER}/platinumcoin-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/platinumcoin-build.assert
```
...
[platinumcoin/gitian.sigs](https://github.com/platinumcoin/gitian.sigs/) repository, or
