The following is a list of assets used in the platinumcoin source and their proper attribution.
...
* License: MIT
* Site: [https://platinumcointalk.org/index.php?topic=15276.0](https://platinumcointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original platinumcoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/platinumcoin.icns, src/qt/res/src/platinumcoin.svg,
	src/qt/res/src/platinumcoin.ico, src/qt/res/src/platinumcoin.png,
	src/qt/res/src/platinumcoin_testnet.png, docs/platinumcoin_logo_doxygen.png,
