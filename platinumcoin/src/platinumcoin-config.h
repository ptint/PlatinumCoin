/* src/platinumcoin-config.h.  Generated from platinumcoin-config.h.in by configure.  */
/* src/platinumcoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef PLATINUMCOIN_CONFIG_H

#define PLATINUMCOIN_CONFIG_H
...
/* Define this symbol if you have operating system IPv6 support */
#define HAVE_IPV6 1
...
#define PACKAGE_BUGREPORT "info@platinumcoin.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Platinumcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Platinumcoin Core 0.1.4"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "platinumcoin"
