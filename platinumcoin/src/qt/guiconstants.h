...
/* PlatinumcoinGUI -- Size of icons in status bar */
...
#define QAPP_ORG_DOMAIN "platinumcoin.info"
#define QAPP_APP_NAME_DEFAULT "Platinumcoin-Qt"
#define QAPP_APP_NAME_TESTNET "Platinumcoin-Qt-testnet"
