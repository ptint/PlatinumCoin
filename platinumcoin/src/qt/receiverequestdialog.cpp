...
#include "platinumcoin-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatPlatinumcoinURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + PlatinumcoinUnits::formatWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatPlatinumcoinURI(info));
}
