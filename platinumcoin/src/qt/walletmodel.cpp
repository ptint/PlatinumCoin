...
{
    CPlatinumcoinAddress addressParsed(address.toStdString());
...
WalletModel::SendCoinsReturn WalletModel::prepareTransaction(WalletModelTransaction &transaction, const CCoinControl *coinControl)
{
    ...
    foreach(const SendCoinsRecipient &rcp, recipients)
    {
        ...
        {   // User-entered platinumcoin address / amount:
            ...
            CKeyID id = boost::get<CKeyID>(CPlatinumcoinAddress(rcp.address.toStdString()).Get());
...
{
    QString strAddress = QString::fromStdString(CPlatinumcoinAddress(address).ToString());
...
void WalletModel::listCoins(std::map<QString, std::vector<COutput> >& mapCoins) const
{
    ...
    BOOST_FOREACH(const COutput& out, vCoins)
    {
        ...
        mapCoins[CPlatinumcoinAddress(address).ToString().c_str()].push_back(out);
    }
#else
    assert(0);
#endif
...
{
    CTxDestination dest = CPlatinumcoinAddress(sAddress).Get();
