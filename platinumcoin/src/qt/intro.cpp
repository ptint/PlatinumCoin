...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/platinumcoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Platinumcoin"),
     ...
     * override -datadir in the platinumcoin.conf file in the default data directory
     * (to be consistent with platinumcoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
