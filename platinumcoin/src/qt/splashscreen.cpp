    ...
    QSplashScreen(pixmap, f)
{
    ...
    QString titleText       = tr("Platinumcoin");
    QString versionText     = QString("Version %1").arg(QString::fromStdString(FormatFullVersion()));
//    QString copyrightText   = QChar(0xA9)+QString(" %1 ").arg(COPYRIGHT_YEAR) + QString(tr("Platinum Coin s.r.o"));
    QString copyrightText   = QChar(0xA9)+ QString(tr(" 2018 Platinum Coin s.r.o"));
