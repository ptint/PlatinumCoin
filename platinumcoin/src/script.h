...
#ifndef H_PLATINUMCOIN_SCRIPT
#define H_PLATINUMCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CPlatinumcoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Platinumcoin always counted CHECKMULTISIGs
