...
#ifndef _PLATINUMCOINRPC_PROTOCOL_H_
#define _PLATINUMCOINRPC_PROTOCOL_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // Platinumcoin is not connected
